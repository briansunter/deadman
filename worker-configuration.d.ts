/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eecc1c04b9d345dd97a8b4aa31a1c7db)
// Runtime types generated with workerd@1.20260301.1 2025-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "HeartbeatMonitor";
	}
	interface Env {
		EMAIL: SendEmail;
		HEARTBEAT_TIMEOUT_SECONDS: "300";
		ALERT_COOLDOWN_SECONDS: "900";
		HEARTBEAT_MONITOR: DurableObjectNamespace<import("./src/index").HeartbeatMonitor>;
	}
}
